        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Or{' '}
              <a href="#" className="font-medium text-green-700 hover:text-green-300">
                Sign Up Here
              </a>
            </p>
          </div>
            ...
            <div>
              ...
              >
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  <LockClosedIcon className="h-5 w-5 text-green-700 group-hover:text-green-300" aria-hidden="true" />
                </span>
                Sign In
              </button>
            </div>
